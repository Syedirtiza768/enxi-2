    ...
    const loadUserInfo = async (): Promise<void> => {
      ...
      if (token) {
        try {
          ...
          console.warn('Token payload:', payload) // Debug log
          setUser({
      ...
      try {
        ...
        if (response.ok && response.data) {
          if (response.data.settings?.companyName) {
            setCompanySettings({ name: response.data.settings.companyName })
          }
          // Also update with logo if available
          if (response.data.settings?.logoUrl) {
            setCompanySettings(prev => ({ ...prev, logoUrl: response.data.settings.logoUrl }))
          }
        }
      } catch (error) {
              ...
              <HStack gap="sm" align="center" className="hidden sm:flex">
                {companySettings.logoUrl ? (
                  ...
                  <svg className="w-8 h-8" viewBox="0 0 1024 1024" fill="currentColor">
                    ...
                    <path fill="#000000" opacity="1.000000" stroke="none" 
                      d="
                    M902.655640,515.999878 
                      C902.881165,494.536224 902.137878,473.562317 903.554382,452.607544 
                      C903.792908,449.079071 904.574097,447.521851 908.385864,447.599731 
                      C918.203552,447.800385 928.029907,447.786285 937.848755,447.619751 
                      C941.428284,447.559082 942.381653,449.031982 942.375977,452.364441 
                      C942.300720,496.645508 942.282654,540.926819 942.371582,585.207825 
                      C942.379578,589.185852 940.904602,590.432800 937.062012,590.324463 
                      C928.244934,590.075745 919.418579,590.156677 910.595947,590.104126 
                      C903.572449,590.062256 902.980652,589.664124 902.826721,582.419861 
                      C902.611023,572.269348 902.681885,562.112549 902.663513,551.958313 
                      C902.642212,540.138855 902.656799,528.319397 902.655640,515.999878 
                    z"/>
                    <path fill="#000000" opacity="1.000000" stroke="none" 
                      d="
                    M942.344666,420.989502 
                      C942.351013,434.311218 942.350525,434.269257 929.470581,434.415924 
                      C922.493164,434.495361 915.512817,434.642426 908.543030,434.960175 
                      C904.504089,435.144287 902.491211,433.813263 902.240051,429.459229 
                      C901.703064,420.152313 901.872986,410.850403 901.866943,401.544861 
                      C901.864624,397.989716 903.620056,396.564178 907.201294,396.706970 
                      C917.658508,397.123779 928.121887,397.421783 938.585571,397.616577 
                      C941.412415,397.669220 942.377380,398.861298 942.345581,401.539429 
                      C942.270508,407.855835 942.335571,414.173920 942.344666,420.989502 
                    z"/>
                    <path fill="#000000" opacity="1.000000" stroke="none" 
                      d="
                    M308.276978,495.834595 
                      C313.768738,501.796417 313.744537,503.528748 308.413361,509.013153 
                      C296.807007,520.952881 285.174316,532.867310 273.625702,544.862610 
                      C269.907166,548.724976 265.382721,550.359497 260.181702,550.349121 
                      C235.534760,550.300110 210.887894,550.218567 186.241089,550.123047 
                      C182.995361,550.110474 180.294418,549.533936 180.317688,545.235291 
                      C180.465546,517.928101 180.527679,490.620422 180.599854,463.312866 
                      C180.623093,454.524109 180.902573,454.090973 189.869324,454.037231 
                      C212.185013,453.903442 234.501572,453.922760 256.817535,453.823273 
                      C264.205994,453.790344 270.151276,456.297180 275.321350,461.875488 
                      C285.958099,473.352173 297.085693,484.373962 308.276978,495.834595 
                    z"/>
                  </svg>
                )}
                <VStack gap="none">
